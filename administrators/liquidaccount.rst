...
* Campus will open the IQNOMY support documentation.
* Your :term:`Liquid Account` name to visualize in which account you are working.
* Clicking on :ref:`Liquid Accounts <liquid-account-overview>` will bring you back to the overview of your liquid accounts.
* Hovering your username will dropdown a link to:
   * My account where you can change your :ref:`User account` settings.
   * :ref:`Liquid Account details <liquid-account-details>`
   .. index:: Logout
...
* Links to the :ref:`discovery <discovery>` page for configuration.
* Link to :ref:`Live Stream <live-stream>`
* Link to :ref:`EngageScore <engagescore>`
* Link to :ref:`Dimensions overview <dimensions-overview>`
...
.. glossary::
   Liquid account
      You can change the main settings of the Liquid Account you are managing at the moment. One user can have access to multiple Liquid Accounts. For every liquid account different roles (owner, administrator or reporter) can be set. The Liquid Account provides access to the services for connecting communication channels, collect and enrich profiles and personalize content.
...
.. index:: Tenant id
.. index:: Liquid account id

Your IQNOMY ID
    Id of this tenant. You use this id in the webservices or Tracking integration with website
Company Name
    Name of your Liquid Account. This name is visible when logging in and choosing your Liquid Account. Every liquid account has a unique number. So this name is not an unique identifier.
Description
